...
namespace echo
{
    ...
    public class V2_CraneSpecs : ScriptableObject
    {
        
        [SerializeField] [Range(.1f, 10f)] private float _craneSpeed = 0.75f; //Speed in m/s
        [SerializeField] [Range(.1f, 1f)] private float _craneAcceleration = 1f; //Acceleration in m/s²
        [SerializeField] [Range(.1f, 10f)] private float _cabinSpeed = 4; //Speed in m/s
        [SerializeField] [Range(.1f, 1f)] private float _cabinAcceleration = 1f; //Acceleration in m/s²
        [SerializeField] [Range(.1f, 10f)] private float _winchSpeed = 4; //Speed in m/s        
        [SerializeField] [Range(.1f, 10f)] private float _maxSwing = 4; // Max amount of swing allowed. This is used to keep the spreader still in easier training sessions
